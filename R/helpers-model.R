...
#'
#' @details This function is deprecated. Please use `stancode()` or `make_stancode()` (if using
#' `brms` >= 2.20.14) instead. In `brms` >= 2.20.14, `make_stancode()` became an
#' alias for `stancode()`, and `stancode()` is the recommended function to use.
