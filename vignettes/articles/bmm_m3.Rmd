...
my_priors <- list(
  c = list(main = "normal(2, 0.5)", effect = "normal(0, 0.5)"),
  a = list(main = "normal(0, 0.5)", effect = "normal(0, 0.5)"),
  d = list(main = "normal(0, 0.5)", effect = "normal(0, 0.5)")
)
...
```{r}
post_diff <- c(
  c_newVoldR = "c_condnewdistractors = c_condoldreordered",
  c_newVoldS = "c_condnewdistractors = c_condoldsame",
  c_oldRVolds = "c_condoldreordered = c_condoldsame",
  a_newVoldR = "a_condnewdistractors = a_condoldreordered",
  a_newVoldS = "a_condnewdistractors = a_condoldsame",
