...
The Signal Discrimination Model is a measurement model for contninuous reproduction tasks in the visual working memory domain. The model was originally introduced by @Oberauer_2023. As other measurement models for continuous reproduction tasks, it's goal is to model the distribution of angular response errors.
