---
title: "Extracting default priors, the generated Stan code and data"
...
header-includes:
  - \usepackage{amsmath}
vignette: >
  %\VignetteIndexEntry{Extracting default priors, the generated Stan code and data}
...
```r
fit <- fit_model(bmf(c ~ 0 + set_size, kappa ~ 0 + set_size), 
                 data = OberauerLin_2017,
                 model = sdmSimple(resp_err = 'dev_rad'))
stancode(fit)
```
